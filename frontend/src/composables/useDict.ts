...
export const CATEGORY_LABELS: Record<string, string> = {
  ...
  notification_link_type: '通知跳转类型',
  notification_business_type: '通知业务类型',
  notification_outbox_status: '通知Outbox状态',
  notification_provider_health_status: 'Provider健康状态',
  notification_mini_subscription_status: '小程序订阅授权状态',
