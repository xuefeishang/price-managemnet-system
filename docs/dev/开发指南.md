...
样式配置存储在 `sys_dict` 表中，分类为 `style` 和 `theme`：

| 分类 | dictKey | 说明 |
|------|---------|------|
| theme | theme_red_green | 红涨绿跌主题 |
| theme | theme_green_red | 绿涨红跌主题 |
| theme | theme_blue_orange | 蓝涨橙跌主题 |
| theme | theme_purple_gold | 紫涨金跌主题 |
| style | price_rise_color | 涨价颜色 |
| style | price_fall_color | 跌价颜色 |
| style | chart_primary_color | 图表主色 |
| style | chart_colors | 图表配色数组 |
| style | heading_font | 标题字体 |
| style | body_font | 正文字体 |
