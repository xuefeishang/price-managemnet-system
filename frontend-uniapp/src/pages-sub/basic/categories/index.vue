<template>
  <view class="page">
    ...
    <scroll-view class="content" scroll-y>
      <view v-if="!loading && categories.length > 0" class="list">
        <view
      ...
      <view v-else-if="!loading" class="empty">
        ...
        <button class="empty-btn" @click="handleCreate" v-if="userStore.canEdit">创建分类</button>
      </view>
    ...
    <view class="popup" v-if="showEditPopup" @click="showEditPopup = false">
      <view class="popup-content" @click.stop>
        <view class="popup-header">
          <text class="popup-title">{{ editingId ? '编辑分类' : '新增分类' }}</text>
        ...
        <view class="popup-body">
          ...
          <view class="form-item">
            ...
            <input class="form-input" v-model="form.code" placeholder="请输入分类编码" />
          </view>
          <view class="form-item">
...
const handleToggleStatus = async (item: ProductCategory) => {
